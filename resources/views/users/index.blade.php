<x-app-layout>
                ...
                <div class="p-1.5 min-w-full inline-block align-middle">
                    <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden dark:bg-slate-900 dark:border-gray-700">
                        ...
                        <div class="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 dark:border-gray-700">
                            ...
                            <!-- End Input -->
                            @if (Auth::user()->hasPermission('new-user'))
                            <a href="{{ route('users.new') }}" class="py-3 px-4 flex justify-center items-center h-[2.875rem] w-[2.875rem] text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tr class="bg-white hover:bg-gray-50 dark:bg-slate-900 dark:hover:bg-slate-800">
                                    <td class="h-px w-px whitespace-nowrap align-center">
                                        ...
                                        <div class="flex items-center gap-x-3">
                                            <span class="inline-flex items-center justify-center h-[2.375rem] w-[2.375rem] rounded-full bg-blue-600 dark:bg-gray-700">
                                                <span class="font-bold text-white leading-none dark:text-gray-200">{{ Str::of($user->name)->charAt(0) }}</span>
                                            </span>
                                            <div class="grow">
                                    ...
                                    <td class="h-px w-px whitespace-nowrap align-center">
                                        <a class="block py-2 px-6" href="#">
                                            <span class="text-sm text-gray-600 dark:text-gray-400">{{ date('M d, Y H:i', strtotime($user->created_at))}}</span>
                                        </a>
                                    </td>
                                            ...
                                            <div x-show="open" x-transition
                                                ...
                                                @if (Auth::user()->hasPermission('delete-user'))
                                                    <a href="{{ route('users.delete', $user->id) }}"
                                                        class="flex items-center gap-x-3 py-2 px-3 rounded-md text-sm text-red-600 hover:bg-gray-100 dark:text-red-500 dark:hover:bg-gray-700">
                                                        🗑 {{ __('Delete') }}
                                                    </a>
                                                @endif
                                            </div>
                                    ...
                                    <td colspan="4">
                                        <div class="max-w-sm w-full min-h-[300px] flex flex-col justify-center text-center items-center mx-auto px-6 py-4">
                                            ...
                                            <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                                                {{ __('Do you want to create a user?.') }}
                                            </p>
                                            @if (Auth::user()->hasPermission('new-user'))
                                            <div class="mt-5 grid sm:flex gap-2">
                                                <a href="{{ route('users.new') }}" class="py-2 px-3 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
    ...
    <script>
        ...
        function search()
        {
            ...
            if (event.key === "Enter") {
                var url = '{{ route("users.index", ":search") }}';
