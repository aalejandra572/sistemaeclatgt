    ...
    <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
      <div class="mb-8">
        ...
        <p class="text-sm text-gray-600 dark:text-gray-400">
          {{ __('Formulario para registrar clientes.') }}
        </p>
      </div>
      ...
      <form method="POST" action="{{ route('clientes.store') }}">
        ...
        <div class="grid sm:grid-cols-12 gap-2 sm:gap-6">
          ...
          <div class="sm:col-span-3">
            <label for="cliente-nombre" class="inline-block text-sm text-gray-800 mt-2.5 dark:text-gray-200">
              {{ __('Nombre') }} <span class="text-red-600">*</span>
            </label>
          </div>
          <div class="sm:col-span-9">
            <input id="cliente-nombre" name="nombre" type="text" maxlength="100" autocomplete="off"
          ...
          <!-- Apellido -->
          <div class="sm:col-span-3">
            <label for="cliente-apellido" class="inline-block text-sm text-gray-800 mt-2.5 dark:text-gray-200">
              {{ __('Apellido') }} <span class="text-red-600">*</span>
            </label>
          </div>
          <div class="sm:col-span-9">
            <input id="cliente-apellido" name="apellido" type="text" maxlength="100" autocomplete="off"
              class="py-2 px-3 block w-full border-gray-200 text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-300 dark:focus:ring-gray-600"
          ...
          <!-- Teléfono -->
          <div class="sm:col-span-3">
            <label for="cliente-telefono" class="inline-block text-sm text-gray-800 mt-2.5 dark:text-gray-200">
              {{ __('Teléfono') }}
            </label>
          </div>
          <div class="sm:col-span-9">
            <input id="cliente-telefono" name="telefono" type="text" maxlength="20" autocomplete="off"
              class="py-2 px-3 block w-full border-gray-200 text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-300 dark:focus:ring-gray-600"
          ...
          <!-- Dirección -->
          <div class="sm:col-span-3">
            <label for="cliente-direccion" class="inline-block text-sm text-gray-800 mt-2.5 dark:text-gray-200">
              {{ __('Dirección') }}
            </label>
          </div>
          <div class="sm:col-span-9">
            <textarea id="cliente-direccion" name="direccion" rows="3" maxlength="255"
              class="py-2 px-3 block w-full border-gray-200 text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-300 dark:focus:ring-gray-600"
              placeholder="Ej. 5a avenida 10-20, Zona 1">{{ old('direccion') }}</textarea>
