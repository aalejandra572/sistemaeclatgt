<x-app-layout>
  @section('breadcrumbs')
    <li class="text-sm">
      <a class="flex items-center text-sm text-gray-500 hover:text-blue-600 focus:outline-none focus:text-blue-600 dark:focus:text-blue-500" href="{{ route('marcas.index') }}">
    ...
    <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
      <div class="mb-8">
        ...
        <p class="text-sm text-gray-600 dark:text-gray-400">
          {{ __('Formulario para registrar marcas.') }}
        </p>
      </div>
      ...
      <form method="POST" action="{{ route('marcas.store') }}">
        ...
        <div class="grid sm:grid-cols-12 gap-2 sm:gap-6">
          ...
          <div class="sm:col-span-3">
            <label for="marca-nombre" class="inline-block text-sm text-gray-800 mt-2.5 dark:text-gray-200">
              {{ __('Nombre de la marca') }} <span class="text-red-600">*</span>
            </label>
          </div>
          <div class="sm:col-span-9">
            <input id="marca-nombre" name="nombre" type="text" maxlength="150" autocomplete="off"
              ...
              placeholder="Ej. L'Oréal, Neutrogena..."
          ...
          <!-- Descripción -->
          <div class="sm:col-span-3">
            <label for="marca-descripcion" class="inline-block text-sm text-gray-800 mt-2.5 dark:text-gray-200">
              {{ __('Descripción') }}
            </label>
          </div>
          <div class="sm:col-span-9">
            <textarea id="marca-descripcion" name="descripcion" rows="3" maxlength="1000"
              class="py-2 px-3 block w-full border-gray-200 text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-300 dark:focus:ring-gray-600"
              placeholder="Descripción de la marca (opcional)">{{ old('descripcion') }}</textarea>
